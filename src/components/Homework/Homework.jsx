       ...
       <div className="d-flex justify-content-between flex-column  cardbg ">
         ...
         <div className="mt-1 m-5">
           ...
           <div className=" row prevcard d-flex ">
             {deadline ? (
               <>
                 <div className=" col-5 cardbgv2 m-3 rounded-3  p-3">
                   <div>
                     <h2 className=" mt-4"> {info.titlev3}</h2>
                 ...
                 <div className=" col-5 mt-5">
                   {file ? (
                     ...
                     <>
                       <div className="  d-flex justify-content-center align-items-center   cardbgv2 rounded-3 p-3 h-100 flex-column">
                         <Miss className="iconSize2" />
