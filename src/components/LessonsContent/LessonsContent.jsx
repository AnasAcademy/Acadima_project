...
import LessonsNavbar from "@/components/AdminComp/LessonsNavbar/LessonsNavbar";
...
export default function LessonsContent() {
  ...
  return (
    <>
      <div>
        <LessonsNavbar setFull={setFull} full={full} />
      </div>
      <div className=" row  m-3  g-4   ">
        <div className={` col-12  ${full ? "col-lg-12" : "col-lg-9"} `}>
        ...
        >
          <div className=" ">
            <div className=" d-flex m-5 justify-content-around mb-2">
              ...
              >
                <Con className=" iconSize1 iconcolor2" />
              ...
              >
                <Exm className=" iconSize1 iconcolor2" />
              ...
              <div>
                <div className=" d-flex gap-2   align-items-center justify-content-between m-4 prevcard p-2  pe-3 ps-3 rounded-3 flex-column ">
                  {title === "watchlessons" ? (
                    <>
                      <div className=" d-flex  justify-content-between  align-items-center  w-100  ">
                        <div className=" d-flex align-items-center  gap-2 ">
                          <div className="circbg  rounded-circle m-1 p-2 ">
                            <Con className=" iconSize5 iconcolor " />
                          </div>
                          <div>
                      ...
                      {actv && (
                        <div>
                          <p className=" text-light m-3">
                            هنا نص عشوائي يُستخدم لملء الفراغات في التصميم. هذا
                            النص لا يحمل معنى محدد بل يُستخدم لأغراض العرض فقط.
                            يمكنك استخدامه لتجربة توزيع النصوص وتنسيقها في
                            التصميم. النص يتكرر هنا بدون محتوى فعلي لإظهار الشكل
                            النهائي للصفحة.
                          </p>
                        </div>
                      )}
                    ...
                    <>
                      <div
                        className=" cursor-pointer d-flex  justify-content-start align-items-center w-100"
                        onClick={() => {
