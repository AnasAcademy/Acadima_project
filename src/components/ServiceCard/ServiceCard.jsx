      ...
      <div className="row gy-4">
        {services.map((service, index) => (
          <div className="col-12 col-md-6 col-lg-4" key={index}>
            <div className="cardbg p-4 rounded-4 shadow-sm h-100 d-flex flex-column justify-content-between align-items-center align-items-md-start">
              <div>
                ...
                <p
                  className="custfont m-0 text-center text-md-start"
                  style={{ fontSize: "13px" }}
                >
                  {service.description}
                </p>
