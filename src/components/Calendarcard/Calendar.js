...
const loc = useLocale();
 const t = useTranslations();
      ...
      <div className=" cardbg  d-flex flex-column gap-3 ">
        ...
        <div className="">
          ...
          <div className=" d-flex gap-3">
            <div className=" d-flex flex-column   tit-12-500  Gray-Gray-800 ">
  ...
  const renderHeader = () => {
    ...
    return (
      <div className="calendar-header   d-flex flex-row-reverse p-4 w-100 ">
  ...
  const renderDaysOfWeek = () => (
    <div className="calendar-days text-white  ">
      {info.days.map(
        (day, index) => (
  ...
  const renderDates = () => {
    ...
    while (day <= endDate) {
      ...
      rows.push(
        <div className="calendar-week text-white  " key={day}>
          {days}
        </div>
      );
      days = [];
    }
    return <div className="calendar-dates text-white  ">{rows}</div>;
  };
