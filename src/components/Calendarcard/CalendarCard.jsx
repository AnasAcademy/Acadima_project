    ...
    <>
      <div className="p-3 rounded-2  d-flex justify-content-center flex-column   cardbg text-white">
        ...
        <div className=" d-flex flex-column  mb-2   justify-content-center align-items-start ">
          ...
          <div className=" d-flex gap-3">
            <div className=" d-flex flex-column   custsmfont ">
              <p className=" m-0"> {t("event1.times")} </p>{" "}
              <p> {t("event1.timef")} </p>
            </div>

            <div>
              {" "}
              <Image src={blucircle} alt="bluecircle" />{" "}
            </div>

            <div className=" h6v">
              {" "}
              <p className=" mb-1"> {t("event1.lecture")}</p>{" "}
              <p> {t("event1.action")} </p>{" "}
            </div>
          </div>
          ...
          <div className=" d-flex gap-3">
            <div className=" d-flex flex-column  custsmfont ">
              <p className=" m-0"> {t("event2.times")} </p>{" "}
              <p> {t("event2.timef")} </p>
            </div>
        ...
        <div className=" d-flex justify-content-end">
          <button className="btn btn-light custfontbtn mb-3 px-3">
            {" "}
            {t("action")}{" "}
          </button>
        </div>
