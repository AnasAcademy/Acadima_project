      ...
      <div className="d-flex justify-content-between w-100  align-items-center flex-sm-row flex-row flex-md-row flex-lg-row-reverse   ">
        ...
        <div className="d-flex align-items-center">
          <form className="d-none d-sm-none  d-md-none d-lg-flex justify-content-end " style={{ gap: "24px" }} >
            ...
            <div  ref={notfiRef}  className=" d-none d-md-flex align-items-center position-relative ">
            
                <Image src={notfi} alt="notification" width={24} height={27} onClick={toggle}/>


         
             
              { show ==="show" && ( <div className="notfiNavbar  position-absolute d-flex justify-content-center align-items-start flex-column  gap-3 pt-4 pb-4 ps-3 pe-3 cursor-pointer ">

                   { info.map((dat , key )=>{

                     return  <Link href="/notifications">
                       <div key={key} className="mt-3 " onClick={() => handleClick(key)}>
                       <h4 className="custsubtitle3  text-black"> {dat.title}  </h4>
                       <p className="ft text-black">
                         {dat.date}
                       </p>
                     </div>
                      </Link>
            ...
            <Link href="/notifications" className="btn btn-dark custfontbtn border-0"> كل الاشعارات</Link> 
                         </div>
