    ...
    return <>
        ...
        <div className='     flex-column   d-flex '>
            ...
            <nav className="navbar navbar-dark navbar-expand-lg  ">
                <div className="container-fluid  d-flex flex-sm-row flex-lg-column flex-row flex-md-row flex-xl-column min-vh-lg-100  justify-content-center   align-items-start p-0 sidebar    " style={{ gap: "61px" }}>


                        <Image src={logo} alt="acadimaLogo" className='d-none  d-sm-none d-md-none d-lg-flex' />
                    ...
                    <div className="collapse navbar-collapse    " id="navbarSupportedContent " >
                                <ul className="navbar-nav   d-lg-flex  flex-lg-column  justify-content-start align-items-start    p-0 " style={{ gap: "20px" }}>

                           

                            <li className={`nav-item d-flex w-100  text-white align-items-center mt-2 `}>
                                <Image src={dashboard}  alt="Dashboard" />
                                <Link className="nav-link hvv" aria-current="page" href="/dashboard">{t('dashboard')}</Link>
                            </li>
                            ...
                            <li className={`nav-item d-flex text-white  align-items-center `}>
                                ...
                                <Link className="nav-link hvv" aria-current="page" href="/org-settings">{t('Technical Support')}</Link>
                            </li>
                            ...
                            <li className={`nav-item d-flex text-white align-items-center  `}>
                                ...
                                <Link className="nav-link hvv" aria-current="page" href="/engagement/progress-tracker">{t('Account Management')}</Link>
                            </li>

                            <li className={`nav-item d-flex text-white align-items-center  `}>
                                <Image src={schedule} alt="Dashboard" />
                                <Link className="nav-link hvv" aria-current="page" href="/engagement/progress-tracker">{t('elctro')}</Link>
                            </li>

                            <li className={`nav-item d-flex text-white  align-items-center `}>
                                <Image src={settings}  alt="Dashboard" />
                                <Link className="nav-link hvv" aria-current="page" href="/org-settings">{t('AI Assistant')}</Link>
                            </li>

                            <li className={`nav-item d-flex text-white  align-items-center `}>
                                <Image src={logout}  alt="Dashboard" />
                                <Link className="nav-link hvv" aria-current="page" href="/org-settings">{t('logout')}</Link>
                            </li>
