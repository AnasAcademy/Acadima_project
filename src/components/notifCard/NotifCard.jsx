          ...
          <div className="col-xl-5 col-sm-12 col-12 d-flex  flex-column gap-4">
            {info.map((dat, key) => {
              return (
                <div
                  key={key}
                  className="cardbg p-4 rounded-4 shadow-sm  w-100 d-flex flex-column justify-content-between align-items-center align-items-md-start"
                >
                  <div>
                    ...
                    {index === key ? (
                      <p className=" d-xl-none d-lg-none d-sm-flex d-flex">
                        {" "}
                        <div className=" h6v  w-50 message m-3 p-3  ">
                          {MsgData}
                        </div>
                      </p>
                    ) : (
