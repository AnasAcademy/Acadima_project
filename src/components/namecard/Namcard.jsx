      ...
      <div className='  p-4 rounded-2   cardbg '>
          ...
          <div className=' d-flex'>
              ...
              <h4 className=' custfont'> {t('Password')}</h4>
                  ...
                  {   toggle === "show" ? <h4 className=' custfont' >000000</h4> :  <h4 className=' custfont' >______</h4>}

                  <button type="button"   onClick={togglef} className=' border-0 bg-transparent'  >    <Image src={show} alt='show' /></button>
                  </div>
