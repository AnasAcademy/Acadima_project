    ...
    <div className='   container p-3  mt-5 '>
      ...
      <div className=' position-relative col-xl-7 col-lg-7 col-sm-12 col-12'>
        <div className=' position-absolute centered-absolut z-3 '>
          ...
          <Image src={image} alt='back-image' className='w-100 h-auto img-opacity' />
      </div>
        ...
        <div className='mt-5 col-xl-6 col-lg-6 col-sm-12 col-12'>
          ...
          <input type="text" className=' input bg-transparent border-light w-100 mt-4 p-2 rounded-2' placeholder={info.coupon_placeholder}/>
        ...
        <div className=' d-flex justify-content-between'>
          <h2 className='htitle  '> {info.subtotal} </h2>
            ...
            <Image src={line} alt='line'  className='w-100   bg-white  my-2' height={2}/>   
          </div>
          <div className=' d-flex justify-content-between'>
