...
import OverdueHistoryTable from "@/components/Tables&filters/InstallmentsTables/OverdueHistoryTable";

export default async function OverdueHistory() {
  ...
  async function fetchData(pageNumber = 1) {
    try {
      const res = await fetch(
        `${BASE_URL}/financial/installments/overdue_history?page=${pageNumber}`,
        {
          method: "GET",
          headers: {
            "x-api-key": API_KEY,
