...
import CertificateTemplates from "@/components/Tables&filters/CertificatesTable/CertificateTemplates";
  ...
  async function fetchData(pageNumber = 1) {
    try {
      ...
      return {
        ...
        currentPage: respond?.data?.current_page || respond?.current_page || 1,
        totalPages: respond?.data?.last_page || respond?.last_page || 1,
      };
    } catch (error) {
      ...
      <div className="m-0 container-fluid p-0 d-flex flex-column">
        <div className="p-lg-4 pt-lg-0">
          <div className="row m-0 p-2 g-3">
            <h2 className="hvvv">{t("certificate-templates")}</h2>
