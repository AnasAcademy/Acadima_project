...
import ReserveSeatTable from "@/components/Tables&filters/Records/ReserveSeatTable/ReserveSeatTable";

export default async function SeatReservationStudents() {
  ...
  async function fetchData(pageNumber = 1) {
    try {
      const res = await fetch(
        `${baseUrl}/students/reserve_seat?page=${pageNumber}`,
        {
          method: "GET",
          headers: {
